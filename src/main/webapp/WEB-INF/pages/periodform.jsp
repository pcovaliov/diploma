...
<div class="container text-center">
    ...
    <div class="col-md-8 col-md-offset-2 abc">
        <form:form method="POST" action="/savePeriod" modelAttribute="period" class="form-signin">
            ...
            <div class="form-group">
                ...
                <small id="emailHelp" class="form-text text-muted">Period Start Date.
                </small>
            </div>
            <div class="form-group">
                ...
                <small id="emailHelp" class="form-text text-muted">Period End Date.
                </small>
            </div>
            <button type="submit" class="btn btn-primary">Submit</button>
            <form:input type="hidden" path="id" name="id" value="${period.id}"/>
        </form:form>
    </div>
</div>
</body>
