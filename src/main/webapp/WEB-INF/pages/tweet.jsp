                        ...
                        <div class="panel-body" style="border: 0px">
                            <form action="/tweet/addtweet" method="post">
                                        ...
                                        <table style="font-size: xx-large">
                                            <tr>
                                                <td><span style="cursor:pointer"
                                                          onclick="insertAtCaret('tweet', ' 😁');$('#tweet').keyup();$('#tweet').keyup();$('#tweet').keyup();return false;"> 😁</span>
                                                </td>
                                                <td><span style="cursor:pointer"
                                                          onclick="insertAtCaret('tweet', ' 😉');$('#tweet').keyup();$('#tweet').keyup();$('#tweet').keyup();return false;"> 😉</span>
                                                </td>
                                ...
                                <label data-toggle="collapse"
                                       data-target="#demo"
                                       style="cursor: pointer; color: maroon; font-size: x-large; background-color: #FFFFFF; border: none"
                                       for="demo"> 😃
                                </label>

                                <textarea required id="secret" name="secret" hidden></textarea>
                                <input type="submit" class="btn btn-warning btn-sm pull-right"
                                       value="<spring:message code='tweet'/>"
                        ...
                        <div class="col-sm-12">
                            <div class="well reply_wrap" style="text-align:left">
                                <div class="col-sm-2 reply-image">
                                    <img src="${t.user.avatar}" class="reply-img img-circle" height="55" width="55"
                                         alt="Avatar">
                                </div>
                            ...
                            <span style="text-align: left; font-weight: bold">
                                <a href="/user/profile/${t.user.username}"
                                   style="text-decoration: none"> ${t.user.username} </a>
                                    ...
                                    <div class="parent reply_wrap">
                                        <div style="padding-bottom: 10px" class="col-sm-12 fake" data-comment="${t.id}"
                                             onclick="getComments(${t.id},this)">
                                            <a class="small" href="javascript:void(0);"
                                               style="text-decoration: none">${show_comments}</a>
                                        </div>
                                        <div>
                    ...
                    if (data[i].image != null) {
                        if (data[i].image = '') {
                            trHTML += '<img style="width: 100%; padding-bottom: 10px" width="100%"' +
                                    'src="<c:url value="/images/" />' + data[i].image + '">';
                        }
                    }
