  ...
  insert into status values (1,'Task has not yet started.', 'NOT_STARTED');
  insert into status values (2,'Task is in progress.', 'IN_PROGRESS');
  insert into status values (3,'Task is in review.', 'IN_REVIEW');
